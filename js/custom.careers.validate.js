...
var inputs = document.querySelectorAll("form#careerForm input.form-control, textarea, select.form-control");
...
var form = document.querySelector("form#careerForm");
...
function showErrors(form, errors) {
    ...
    form.querySelectorAll("input.form-control, textarea.form-control, select.form-control").forEach(function (input) {
...
function addError(formGroup, error) {
    ...
    errorMessage.style.marginLeft = '2px';
...
function resetForm(){
    ...
    document.querySelectorAll('#careerForm input.form-control, select.form-control, textarea').forEach(input => {
        input.value = '';
    })
}
