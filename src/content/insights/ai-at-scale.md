---
title: "AI at scale is an operating model decision"
description: "Adoption is no longer the scarce resource. Coherent decisions, controls, and workflows are."
date: 2026-08-06
category: "Enterprise AI"
readingTime: "9 min read"
eyebrow: "Signal · Enterprise AI"
---

Stanford HAI’s 2026 AI Index reports that 88% of surveyed organizations used AI in 2025. That is a useful marker, but it is not evidence that an enterprise knows how to use AI well. Adoption is becoming ordinary. The differentiator is whether the organization can make good decisions about where AI belongs, how it is supervised, and how the work changes around it.
...
NIST’s [AI Risk Management Framework](https://www.nist.gov/itl/ai-risk-management-framework) gives organizations a useful vocabulary for governing these choices. OMB’s [M-24-10 memorandum](https://www.whitehouse.gov/wp-content/uploads/2024/03/M-24-10-Advancing-Governance-Innovation-and-Risk-Management-for-Agency-Use-of-Artificial-Intelligence.pdf) makes the same point in a public-sector context: governance, innovation, and risk management have to move together.
