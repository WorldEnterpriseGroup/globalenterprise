...
The FDA’s current [AI-enabled medical device list](https://www.fda.gov/medical-devices/software-medical-device-samd/artificial-intelligence-enabled-medical-devices) and digital-health guidance keep the evidence question active: authorization is not the same as durable performance in every population, site, protocol, or workflow. Static benchmarks do not predict performance in dynamic, real-world environments; a trustworthy capability needs a post-deployment evidence loop.
