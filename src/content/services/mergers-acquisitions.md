...
sources:
  - label: "UN DESA, Future in Focus: Preparing for What Lies Ahead"
    url: "https://www.un.org/esa/foresight/chapter-three.html"
    published: "2024"
    reviewed: 2026-08-13
  - label: "ITU, Facts and Figures (latest global estimate)"
...
1. **Physical and energy:** power, cooling, facilities, transmission, spectrum, orbit, maintenance, and supply-chain dependencies.
2. **Communications:** terrestrial and satellite paths, network diversity, latency, availability, coverage, sovereignty, and partner exposure.
3. **Data and intelligence:** ownership, provenance, access, quality, model evaluation, cybersecurity, and human review.
4. **Finance and capital:** cash flows, funding gates, insurance, liquidity, capital allocation, and the value of optionality under uncertainty.
5. **Market and customer:** the promise, brand, channel, pricing, language, regulatory boundary, and adoption friction that make the capability useful.
6. **Service and change:** owners, incidents, problems, changes, configuration, releases, continuity, knowledge, and continual improvement.
