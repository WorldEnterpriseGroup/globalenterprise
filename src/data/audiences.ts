...
export const audiencePathways: AudiencePathway[] = [
  ...
  {
    id: "international-government-and-multilateral-systems",
    priority: "P0",
    eyebrow: "Institutional systems",
    title: "International government, UN/NATO & multilateral institutions",
    description: "National and international government leaders, UN/NATO readers, and multilateral institutions looking to coordinate shared services, interoperability, sovereignty, and capability transfer across institutions and borders.",
    href: "/services/whole-of-government-international-systems/",
    linkLabel: "Explore whole-of-government & international systems",
    destinationKey: "globalEnterprise",
    destinationLabel: "Global Enterprise",
    external: false,
    audienceKeys: ["international-government-leaders", "multilateral-institutions"],
    supportingHref: "/industries/federal-public-service/",
    supportingLabel: "Explore public-sector advisory",
  },
  {
  ...
  },
  {
    ...
    destinationLabel: "Global Enterprise",
    external: false,
    audienceKeys: ["federal-architecture-leaders", "enterprise-architecture-practitioners", "government-service-management", "devsecops-and-platform-operators"],
    supportingHref: "/services/operating-model/",
    supportingLabel: "Connect it to the operating model",
  },
  {
    id: "solution-strategists-and-technical-authorities",
    priority: "P0",
    eyebrow: "Solution design",
    title: "Solution strategists, service-product strategists & technical authorities",
    description: "Solution strategists, service-product strategists, and technical authorities who need the interfaces, decisions, and operating conditions around a solution made explicit.",
    href: "/services/solution-architecture/",
    linkLabel: "Explore the solution architecture pathway",
    destinationKey: "globalEnterprise",
    destinationLabel: "Global Enterprise",
    external: false,
    audienceKeys: ["enterprise-architecture-practitioners", "government-transformation-operators", "government-service-management", "devsecops-and-platform-operators"],
    supportingHref: "/services/operating-model/",
    supportingLabel: "Connect it to the operating model",
  },
  {
