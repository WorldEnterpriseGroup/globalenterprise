...
export const imageManifest: Record<string, PhotoDefinition> = {
  ...
  "home-pressure-point": {
    ...
    alt: "A field engineer checking a weathered utility control cabinet with a paper checklist at dusk",
    role: "judgment and physical controls under pressure",
    focalPoint: "engineer and cabinet in the right two-thirds; wet utility yard opens into the left third",
    promptIntent: "documentary utility field photograph of human judgment at a physical control boundary",
    createdAt: "2026-08-16",
    source: "generated",
  },
  "home-platform-convergence": {
    src: "/media/original/home-platform-convergence.avif",
    alt: "A gloved engineer tracing a paper systems sketch beside fiber, copper, and cooling infrastructure",
    role: "physical foundations of a connected platform",
    focalPoint: "paper systems sketch and gloved hand in the center; cables and pipes create diagonal depth",
    promptIntent: "tactile infrastructure still life showing authority, foundations, execution, and human judgment",
    createdAt: "2026-08-16",
    source: "generated",
  },
  "home-hub-mea": {
    src: "/media/original/home-hub-mea.avif",
    alt: "Local technicians beside a solar and water infrastructure corridor at dawn",
    role: "Middle East and Africa regional capability transfer",
    focalPoint: "technicians and infrastructure corridor across the middle third; solar field leads into the horizon",
    promptIntent: "documentary civic-digital infrastructure corridor showing local capability and durable foundations",
    createdAt: "2026-08-16",
    source: "generated",
  },
  "home-hub-na": {
    src: "/media/original/home-hub-na.avif",
    alt: "An operations crew reviewing a route map beside layered rail, road, and public infrastructure",
    role: "North American scale and mission coordination",
    focalPoint: "crew and route map in the lower left; rail, roadway, and water infrastructure converge toward the horizon",
    promptIntent: "documentary metropolitan infrastructure interchange connecting scale, mission, and continuity",
    createdAt: "2026-08-16",
    source: "generated",
  },
  "home-hub-eu": {
    src: "/media/original/home-hub-eu.avif",
    alt: "A researcher annotating a systems diagram beside a European tram and civic building",
    role: "European principles translated into practice",
    focalPoint: "researcher and diagram in the right third; tram platform and civic architecture create geometric rhythm",
    promptIntent: "documentary public-mobility scene showing governance and interoperability in everyday practice",
    createdAt: "2026-08-16",
    source: "generated",
  },
  "home-hub-latam": {
    src: "/media/original/home-hub-latam.avif",
    alt: "A public-service team walking through a wet hillside service corridor after rain",
    role: "Latin America and Caribbean trust and adoption",
    focalPoint: "service team in the middle distance; drainage, clinic or school, and communications mast layer the scene",
    promptIntent: "dignified documentary public-service corridor showing trust, adoption, and local delivery",
    createdAt: "2026-08-16",
    source: "generated",
  },
  "home-hub-sa": {
    src: "/media/original/home-hub-sa.avif",
    alt: "A field technician checking a communications relay above a South American mountain logistics corridor",
    role: "South American continuity and local adaptation",
    focalPoint: "relay and technician in the right foreground; mountain valley, road, and water channel extend behind",
    promptIntent: "documentary mountain infrastructure scene showing capability built around continuity",
    createdAt: "2026-08-16",
    source: "generated",
  },
  "home-hub-asia": {
    src: "/media/original/home-hub-asia.avif",
    alt: "Two port operators reviewing a route board beside containers and intermodal equipment at dawn",
    role: "Asia-Pacific interoperability and network speed",
    focalPoint: "operators in the left third; wet loading lane and container equipment converge toward the harbor",
    promptIntent: "ground-level documentary port scene showing speed coordinated through human handoffs",
    createdAt: "2026-08-16",
    source: "generated",
  },
